...
Map::Map()
{
	...
	Room* moreForest = new Room("a blood trail", "You travel deeper into the forest.\nYou see a bloody trail heading south", "You see a bloody trail heading south");
	m_AllRooms.push_back(moreForest);

	Room* southForest = new Room("a bloodtrail", "You and at the southern end of the forest.\nThe forest seems to open up to the west and south.\nThe bloody trail heads west.", "The forest seems to open up to the west and south.\nThe bloody trail heads west.");
	...
	Room* canyonFloor = new Room("the canyon floor", "You made it to the bottom of the canyon.\nLooks like a knight might have fallen down this canyon.", "Looks like a knight might have fallen down this canyon.", "Amongst the rubble you see: ", true, "ROPE");
	...
	Room* treasureRoom = new Room("a treasure room", "You are in the treasure room of the cave.\nThere is a weapon stand holding an impressive looking battleaxe.", "There is a weapon stand holding an impressive looking battleaxe.", "In the cave you see: ", true, "BOOK");
	...
	Room* oldcabin = new Room("an Old Cabin", "You are in the forest next to an old cabin.\nIn this thick forest you see an old cabin\nthat is being occupied by the goblin.", "In this thick forest you see an old cabin\nthat is being occupied by the goblin.");
	...
	Room* mountain = new Room("a Mountain", "You are at the foot of a giant mountain.\nAt the foot of the mountain it appears miners\nhave been picking away at the stone.", "At the foot of the mountain it appears miners\nhave been picking away at the stone.");
	...
	Room* swamp = new Room("a Swamp", "You are in a nasty swamp surrounded by flies.\nThis nasty swamp is so smelly but this stump\nlooks like someone has stashed somthing in it.", "This nasty swamp is so smelly but this stump\nlooks like someone has stashed somthing in it.");
	...
	Room* castleGates = new Room("the Castle Gates", "You are at the gates of a massive castle.\nThe castle gates look old but the old\nlock still looks strong.", "The castle gates look old but the old\nlock still looks strong.");
	m_AllRooms.push_back(castleGates);

	Room* courtyard = new Room("a Courtyard behind castle gates", "You are in the courtyard of the castle\nThis courtyard looks like is used to be a busy place.", "This courtyard looks like is used to be a busy place.", "On some of the merchant stands you see: ", true, "GATEKEY");
	...
	Room* castleHall = new Room("a Throne Room", "You are standing in an abandoned throne room.\nThis throne room doesn't look like it's in as\nbad of shape as the rest of the castle.", "This throne room doesn't look like it's in as\nbad of shape as the rest of the castle.");
	...
	Room* magicRoom = new Room("a Magical Barrier", "You are standing in a old magicians study. There is a portal westward.\nLooks like this place is definitely lived in.\nThe torches are still warm.", "Looks like this place is definitely lived in.\nThe torches are still warm.", "On the wooden tables you see: ", true, "SCROLL");
